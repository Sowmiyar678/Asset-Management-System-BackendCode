...
public class EmployeeController {
	...
	public ResponseEntity<String> register(@RequestBody Employee employee) {
		try {
			...
			if (employee.getEmail() == null || employee.getPassword() == null || employee.getPhoneno() == null
					|| employee.getLocation() == null || employee.getName() == null) {
			...
			message.setText("Your Registered email and password ," + employee.getName() + " "
					...
					+ employee.getEmail() + " " + "Password - " + " " + employee.getPassword() + " Employee ID - " + " "
					+ employee.getEmpid());
	...
	public ResponseEntity<?> updateEmployee(@PathVariable("empid") Long empid, @RequestBody Employee updatedEmployee) {
