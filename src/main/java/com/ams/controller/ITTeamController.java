...
public class ITTeamController {
	...
	public ResponseEntity<String> register(@RequestBody ITTeam itteam) {
		try {
			...
			if (itteam.getEmail() == null || itteam.getPassword() == null || itteam.getPhoneno() == null
					|| itteam.getLocation() == null || itteam.getName() == null) {
//	                return ResponseEntity.badRequest().body("All fields are required.");
			...
			message.setText("Your Details has been Registered");
			message.setText("Your Registered email and password ," + itteam.getName() + " "
					+ "You can Login through the following credentials" + " " + "Username - " + " " + itteam.getEmail()
					+ " " + "Password - " + " " + itteam.getPassword() + " Employee ID - " + " "
					+ itteam.getItteamid());
	...
	public ResponseEntity<?> updateITTeam(@PathVariable("itteamid") Long itteamid, @RequestBody ITTeam updatedITTeam) {
